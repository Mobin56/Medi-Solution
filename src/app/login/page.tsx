      ...
      <AnimatedSection className="w-full max-w-md">
        <div className="bg-card dark:bg-dark-card rounded-2xl border border-border dark:border-dark-border p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-sm font-medium text-text-dark dark:text-dark-text mb-1.5 block">{t("login_email")}</label>
            ...
            <div>
              <label className="text-sm font-medium text-text-dark dark:text-dark-text mb-1.5 block">{t("login_password")}</label>
              <div className="relative">
